...
### TO DO: Fix anything from Dr. Boyce's response/add in Km values
...
for elt in ["alfentanil", "aprepitant", "budesonide", "buspirone", "conivaptan", "darifenacin", "darunavir", "dasatinib", "dronedarone", "eletriptan", "eplerenone", "everolimus", "felodipine", "indinavir", "fluticasone", "lopinavir", "lovastatin", "lurasidone", "maraviroc", "midazolam", "nisoldipine", "quetiapine", "saquinavir", "sildenafil", "simvastatin", "sirolimus", "tolvaptan", "tipranavir", "triazolam", "vardenafil", "ticagrelor"]:
    ...
    e = Evidence(ev)
    e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is a 'sensitive' in vivo substrate of CYP3A4. Because a number of CYP3A substrates (e.g., darunavir, maraviroc) are also substrates of P-gp, the observed increase in exposure could be due to inhibition of both CYP3A and P-gp. For more information, see Table 5 on page 44, footnote 6 from Table 5, and Table 7 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "1/12/2015")
    a.insertEvidence("for",e)
    ev.addAssertion(a)
...
for elt in ["amiodarone", "captopril", "carvedilol", "clarithromycin", "conivaptan", "cyclosporine", "diltiazem", "dronedarone", "felodipine", "itraconazole", "quinidine", "ranolazine", "ticagrelor", "verapamil"]:
    ...
    e = Evidence(ev)
    e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is an in vivo inhibitor of P-gp because this showed a >25% increase in digoxin AUC. For more information, see Table 6 on page 49, footnote 2 on page 49, and  Table 12 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "1/15/2015")
    a.insertEvidence("for",e)
    ev.addAssertion(a)
...
for elt in ["azithromycin", "ketoconazole"]:
    a = Assertion(elt, "inhibits", "P-gp")
    e = Evidence(ev)
    e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is an in vivo inhibitor of P-gp because this showed a >25% increase in fexofenadine AUC. For more information, see Table 6 on page 49, footnote 4 on page 49, and Table 12 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "1/22/2015")
    a.insertEvidence("for",e)
    ev.addAssertion(a)

a = Assertion("erythromycin", "inhibits", "P-gp")
e = Evidence(ev)
e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is an in vivo inhibitor of P-gp because this showed a >25% increase in talinolol AUC. For more information, see Table 6 on page 49, footnote 5 on page 49, and Table 12 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "1/15/2015")
a.insertEvidence("for",e)
ev.addAssertion(a)
...
for elt in ["aliskiren", "ambrisentan", "colchicine", "dabigatran", "etexilate", "digoxin", "everolimus", "fexofenadine", "imatinib", "lapatinib", "maraviroc", "nilotinib", "posaconazole", "ranolazine", "saxagliptin", "sirolimus", "sitagliptin", "talinolol", "tolvaptan", "topotecan"]:
    ...
    e = Evidence(ev)
    e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is an in vivo substrate of P-gp. For more information, see Table 7 on page 51 and also see Table 13 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "1/15/2015")
    a.insertEvidence("for",e)
    ev.addAssertion(a)
...
for elt in ["ketoconazole", "itraconazole"]:
    ...
    e = Evidence(ev)
    e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is a preferred chemical inhibitor of CYP3A4/5 for in vitro experiments. See Table 1 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "2/2/2015")
    a.insertEvidence("for",e)
    ev.addAssertion(a)
...
for elt in ["azamulin", "troleandomycin", "verapamil"]:
    ...
    e = Evidence(ev)
    if elt == "azamulin":
        e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of CYP3A4/5 for in vitro experiments. Azamulin is a specific time-dependent inhibitor of CYP3A4/5. See Table 1 and footnote 6 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "2/2/2015")
        a.insertEvidence("for",e)
        ev.addAssertion(a)
    else:
        e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of CYP3A4/5 for in vitro experiments. See Table 1 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "2/2/2015")
        a.insertEvidence("for",e)
        ev.addAssertion(a)
...
for elt in ["digoxin", "loperamide", "quinidine", "vinblastine", "talinolol"]:
    ...
    if elt == "vinblastine":
        ...
        e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical substrate of P-gp for in vitro experiments. See Table 8 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015")
        a.insertEvidence("for",e)
        ev.addAssertion(a)
...
for elt in ["cyclosporine A", "ketoconazole", "zosuquidar trichloride", "nelfinavir", "quinidine", "ritonavir", "saquinavir", "tacrolimus", "valspodar", "verapamil", "elacridar", "reserpine"]:
    ...
    if elt == "cyclosporine A" or elt ==  "ketoconazole" or elt == "nelfinavir" or elt == "ritonavir" or elt == "saquinavir":
        ...
        e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of P-gp for in vitro experiments. See Table 9 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015")
        a.insertEvidence("for",e)
        ev.addAssertion(a)
...
e = Evidence(ev)
e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is an in vivo inhibitor of P-gp. For more information, see Table 8 on page 53 and also see Table 14 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015")
a.insertEvidence("for",e)
ev.addAssertion(a)
...
for elt in ["voriconazole", "nefazodone", "cimetidine"]:
    a = Assertion(elt, "inhibits", "P-gp")
    e = Evidence(ev)
    e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is not an effective in vivo inhibitor of P-gp. This data was derived with digoxin. For more information, see Table 8 on page 53 of the FDA guidelines and Table 14 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015")
    a.insertEvidence("against",e)
    ev.addAssertion(a)
