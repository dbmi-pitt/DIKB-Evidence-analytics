...
for elt in ["boceprevir", "clarithromycin", "conivaptan", "indinavir", "itraconazole", "ketoconazole", "nefazodone", "nelfinavir", "posaconazole", "ritonavir", "saquinavir", "telaprevir", "telithromycin", "voriconazole"]:
...
for elt in ["amprenavir", "aprepitant", "atazanavir", "ciprofloxacin", "crizotinib", "diltiazem", "erythromycin", "fluconazole", "fosamprenavir", "imatinib", "verapamil"]:
    a = Assertion(elt, "in-viVo-selective-inhibitor-of-enzyme", "cyp3a4")
    e = Evidence(ev)
...
for elt in ["alfentanil", "aprepitant", "budesonide", "buspirone", "conivaptan", "darifenacin", "darunavir", "dasatinib", "dronedarone", "eletriptan", "eplerenone", "everolimus", "felodipine", "indinavir", "fluticasone", "lopinavir", "lovastatin", "lurasidone", "maraviroc", "midazolam", "nisoldipine", "quetiapine", "saquinavir", "sildenafil", "simvastatin", "sirolimus", "tolvaptan", "tipranavir", "triazolam", "vardenafil", "ticagrelor"]:
    ...
    e = Evidence(ev)
    e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is a 'sensitive' in vivo substrate of CYP3A4. Because a number of CYP3A substrates (e.g., darunavir, maraviroc) are also substrates of p-glycoprotein, the observed increase in exposure could be due to inhibition of both CYP3A and p-glycoprotein. For more information, see Table 5 on page 44, footnote 6 from Table 5, and Table 7 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "1/12/2015")
    a.insertEvidence("for",e)
    ev.addAssertion(a)
...
for elt in ["atazanavir", "lopinavir", "saquinavir", "tipranavir"]:
    a = Assertion(elt, "in-viVo-selective-inhibitor-of-enzyme", "oatp1b1")
    e = Evidence(ev)
    e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is an in vivo inhibitor of OATP1B1. Separation of the in vivo inhibition effect from ritonavir is difficult because this drug is usually co-administered with ritonavir. For more information, see Table 6 on page 49, footnote 10 on page 49, and also see Table 12 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "1/22/2015")
    a.insertEvidence("for",e)
    ev.addAssertion(a)

a = Assertion("ritonavir", "in-viVo-selective-inhibitor-of-enzyme", "oatp1b1")
e = Evidence(ev)
e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is an in vivo inhibitor of OATP1B1. The in vivo inhibition effect of ritonavir cannot be easily estimated because it is usually coadministered with other HIV protease inhibitors that are inhibitors for OATP as well. For more information, see Table 6 on page 49, footnote 11 on page 49, and Table 12 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "1/22/2015")
a.insertEvidence("for",e)
ev.addAssertion(a)
...
for elt in ["atazanavir", "lopinavir", "saquinavir"]:
    a = Assertion(elt, "in-viVo-selective-inhibitor-of-enzyme", "oatp1b3")
    e = Evidence(ev)
    e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is an in vivo inhibitor of OATP1B3. Separation of the in vivo inhibition effect from ritonavir is difficult because this drug is usually co-administered with ritonavir. For more information, see Table 6 on page 49, footnote 10 on page 49, and also see Table 12 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "1/22/2015")
    a.insertEvidence("for",e)
    ev.addAssertion(a)

a = Assertion("ritonavir", "in-viVo-selective-inhibitor-of-enzyme", "oatp1b3")
e = Evidence(ev)
...
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is a preferred chemical inhibitor of CYP3A4 for in vitro experiments at a K_i range of 0.0037micM to 0.18micM. See Table 1 on the FDA website. \n\n0.0037micM/L X 1M/10^6micM X 531.430920g/M = 0.0000019662944g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/8/2015", val = "0.0000019662944")
a.insertEvidence("for",e)
ev.addAssertion(a)

a = Assertion_inhibition_constant("itraconazole", "inhibition_constant", "cyp3a4")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is a preferred chemical inhibitor of CYP3A4 for in vitro experiments at K_i's of 0.27micM and 2.3micM. See Table 1 on the FDA website. \n\n0.27micM/L X 1M/10^6micM X 705.633420g/M = 0.0001905210234g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/8/2015", val = "0.0001905210234")
a.insertEvidence("for",e)
ev.addAssertion(a)

a = Assertion_inhibition_constant("troleandomycin", "inhibition_constant", "cyp3a4")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of CYP3A4 for in vitro experiments at K_i's of 0.27micM and 2.3micM. See Table 1 on the FDA website. \n\n0.27micM/L X 1M/10^6micM X 813.968380g/M = 0.0002197714626g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/8/2015", val = "0.0002197714626")
a.insertEvidence("for",e)
ev.addAssertion(a)

a = Assertion_inhibition_constant("verapamil", "inhibition_constant", "cyp3a4")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of CYP3A4 for in vitro experiments at K_i's of 10micM and 24micM. See Table 1 on the FDA website. \n\n10micM/L X 1M/10^6micM X 454.601620g/M = 0.0045460162g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/8/2015", val = "0.0045460162")
a.insertEvidence("for",e)
ev.addAssertion(a)

a = Assertion_inhibition_constant("ketoconazole", "inhibition_constant", "cyp3a5")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is a preferred chemical inhibitor of CYP3A5 for in vitro experiments at a K_i range of 0.0037micM to 0.18micM. See Table 1 on the FDA website. \n\n0.0037micM/L X 1M/10^6micM X 531.430920g/M = 0.0000019662944g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/8/2015", val = "0.0000019662944")
a.insertEvidence("for",e)
ev.addAssertion(a)

a = Assertion_inhibition_constant("itraconazole", "inhibition_constant", "cyp3a5")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is a preferred chemical inhibitor of CYP3A5 for in vitro experiments at K_i's of 0.27micM and 2.3micM. See Table 1 on the FDA website. \n\n0.27micM/L X 1M/10^6micM X 705.633420g/M = 0.0001905210234g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/8/2015", val = "0.0001905210234")
a.insertEvidence("for",e)
ev.addAssertion(a)

a = Assertion_inhibition_constant("troleandomycin", "inhibition_constant", "cyp3a5")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of CYP3A5 for in vitro experiments at K_i's of 0.27micM and 2.3micM. See Table 1 on the FDA website. \n\n0.27micM/L X 1M/10^6micM X 813.968380g/M = 0.0002197714626g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/8/2015", val = "0.0002197714626")
a.insertEvidence("for",e)
ev.addAssertion(a)

a = Assertion_inhibition_constant("verapamil", "inhibition_constant", "cyp3a5")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of CYP3A5 for in vitro experiments at K_i's of 10micM and 24micM. See Table 1 on the FDA website. \n\n10micM/L X 1M/10^6micM X 454.601620g/M = 0.0045460162g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/8/2015", val = "0.0045460162")
a.insertEvidence("for",e)
ev.addAssertion(a)
...
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of p-glycoprotein for in vitro experiments at an IC50 of 1.2micM using a Caco-2 permeability assay with digoxin as a p-glycoprotein substrate. See Table 9 and the footnotes on the FDA website. \n\n1.2micM/L X 1M/10^6micM X 531.430920g/M = 0.000637717104g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015", val = "0.000637717104")
a.insertEvidence("for",e)
ev.addAssertion(a)
...
a = Assertion_inhibition_constant("zosuquidar trihydrochloride", "inhibition_constant", "p-glycoprotein")
e = In_vitro_inhibition_study(ev)
...
a = Assertion_inhibition_constant("quinidine", "inhibition_constant", "p-glycoprotein")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of p-glycoprotein for in vitro experiments at a Ki of 3.2micM using a Caco-2 permeability assay with digoxin as a p-glycoprotein substrate. See Table 9 and the footnotes on the FDA website. \n\n3.2micM/L X 1M/10^6micM X 324.416760g/M = 0.001038133632g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015", val = "0.001038133632")
a.insertEvidence("for",e)
ev.addAssertion(a)

a = Assertion_inhibition_constant("quinidine", "inhibition_constant", "p-glycoprotein")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of p-glycoprotein for in vitro experiments at a Ki of 8.6micM using a MDCK-MDR1 permeability assay with digoxin as a p-glycoprotein substrate. See Table 9 and the footnotes on the FDA website. \n\n8.6micM/L X 1M/10^6micM X 324.416760g/M = 0.002789984136g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015", val = "0.002789984136")
a.insertEvidence("for",e)
ev.addAssertion(a)

a = Assertion_inhibition_constant("ritonavir", "inhibition_constant", "p-glycoprotein")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of p-glycoprotein for in vitro experiments at an IC50 of 3.8micM using a Caco-2 permeability assay with digoxin as a p-glycoprotein substrate. See Table 9 and the footnotes on the FDA website. \n\n3.8micM/L X 1M/10^6micM X 720.944220g/M = 0.002739588036g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015", val = "0.002739588036")
a.insertEvidence("for",e)
ev.addAssertion(a)

a = Assertion_inhibition_constant("saquinavir", "inhibition_constant", "p-glycoprotein")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of p-glycoprotein for in vitro experiments at an IC50 of 6.5micM using a Caco-2 permeability assay with digoxin as a p-glycoprotein substrate. See Table 9 and the footnotes on the FDA website. \n\n6.5micM/L X 1M/10^6micM X 670.840800g/M = 0.0043604652g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015", val = "0.0043604652")
a.insertEvidence("for",e)
ev.addAssertion(a)
...
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of p-glycoprotein for in vitro experiments at an IC50 of 2.1micM using a Caco-2 permeability assay with digoxin as a p-glycoprotein substrate. See Table 9 and the footnotes on the FDA website. \n\n2.1micM/L X 1M/10^6micM X 454.601620g/M = 0.000954663402g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015", val = "0.000954663402")
a.insertEvidence("for",e)
ev.addAssertion(a)
...
a = Assertion_inhibition_constant("verapamil", "inhibition_constant", "p-glycoprotein")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of p-glycoprotein for in vitro experiments at a Ki of 15micM using a MDCK-MDR1 permeability assay with digoxin as a p-glycoprotein substrate. See Table 9 and the footnotes on the FDA website. \n\n15micM/L X 1M/10^6micM X 454.601620g/M = 0.0068190243g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015", val = "0.0068190243")
a.insertEvidence("for",e)
ev.addAssertion(a)

a = Assertion_inhibition_constant("verapamil", "inhibition_constant", "p-glycoprotein")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of p-glycoprotein for in vitro experiments at a Ki of 23micM using a LLC-PK1-MDR1 permeability assay with vinblastine as a p-glycoprotein substrate. See Table 9 and the footnotes on the FDA website. \n\n23micM/L X 1M/10^6micM X 454.601620g/M = 0.01045583726g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015", val = "0.01045583726")
a.insertEvidence("for",e)
ev.addAssertion(a)
...
a = Assertion_inhibition_constant("reserpine", "inhibition_constant", "p-glycoprotein")
e = In_vitro_inhibition_study(ev)
e.create(doc_p = "http://www.fda.gov/drugs/developmentapprovalprocess/developmentresources/druginteractionslabeling/ucm093664.htm#cypEnzymes", q = "The FDA guidelines suggest that this is an acceptable chemical inhibitor of p-glycoprotein for in vitro experiments at a Ki of 11.5micM using a MDCK-MDR1 permeability assay with digoxin as a p-glycoprotein substrate. See Table 9 and the footnotes on the FDA website. \n\n11.5micM/L X 1M/10^6micM X 608.678700g/M = 0.00699980505g/L", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015", val = "0.00699980505")
a.insertEvidence("for",e)
ev.addAssertion(a)
...
for elt in ["quinidine", "felodipine", "azithromycin"]:
    a = Assertion(elt, "in-viVo-selective-inhibitor-of-enzyme", "cyp3a4")
    e = Evidence(ev)
    e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is a 'weak' in vivo inhibitor of CYP3A4. For more information, see Table 8 on page 53 and also see Table 14 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015")
    a.insertEvidence("for",e)
    ev.addAssertion(a)

a = Assertion("lapatinib", "in-viVo-selective-inhibitor-of-enzyme", "p-glycoprotein")
e = Evidence(ev)
e.create(doc_p = "http://www.fda.gov/downloads/drugs/guidancecomplianceregulatoryinformation/guidances/ucm292362.pdf", q = "The FDA guidelines suggest that this is an in vivo inhibitor of p-glycoprotein. For more information, see Table 8 on page 53 and also see Table 14 on the FDA website.", ev_type = "Non_Tracable_Statement", revwr = "roskos", timestamp = "6/9/2015")
a.insertEvidence("for",e)
ev.addAssertion(a)
